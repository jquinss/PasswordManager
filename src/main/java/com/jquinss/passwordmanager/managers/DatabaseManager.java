...
public class DatabaseManager {
    private static final String CREATE_TABLES_STATEMENT = """
            ...
            CREATE TABLE IF NOT EXISTS folder (folder_id INTEGER PRIMARY KEY, parent_folder_id INTEGER folder_name TEXT NOT NULL, description TEXT);
            CREATE TABLE IF NOT EXISTS password_entity (password_entity_id INTEGER PRIMARY KEY, name TEXT NOT NULL, 
            password TEXT NOT NULL, URL TEXT, description TEXT, expires INTEGER NOT NULL DEFAULT 0,
    ...
    private static final String CREATE_INITIAL_CONFIG_STATEMENT = """
            INSERT INTO folder VALUES (0, null, 'root', 'Root folder');
            INSERT INTO password_policy VALUES (0, 'default', 10, 3, 3, 3, 3, 2)""";
    ...
    public void initializeDatabase() throws SQLException {
        try (Connection conn = dataSource.getConnection()) {
            if (conn != null) {
                ...
                stmt.execute(CREATE_INITIAL_CONFIG_STATEMENT);
